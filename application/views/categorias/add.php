<table border="0" width="100%" cellpadding="0" cellspacing="0">
	...
	<td>
		...
		<td class="noheight">
			...
			<tr  valign="top">
				...
				<td><a href=""  id="date-pick"><img src="<?php echo base_url() ?>assets/img/forms/icon_calendar.jpg"   alt="" /></a></td>
			</tr>
			</table>
	...
	<div id="related-activities">
		...
		<img src="<?php echo base_url() ?>assets/img/forms/header_related_act.gif" width="271" height="43" alt="" />
		</div>
		<!-- end related-act-top -->
		...
		<div id="related-act-bottom">
			...
			<div id="related-act-inner">
				...
				<div class="left"><a href=""><img src="<?php echo base_url() ?>assets/img/forms/icon_plus.gif" width="21" height="21" alt="" /></a></div>
				<div class="right">
				...
				<div class="left"><a href=""><img src="<?php echo base_url() ?>assets/img/forms/icon_minus.gif" width="21" height="21" alt="" /></a></div>
				<div class="right">
				...
				<div class="left"><a href=""><img src="<?php echo base_url() ?>assets/img/forms/icon_edit.gif" width="21" height="21" alt="" /></a></div>
				<div class="right">
